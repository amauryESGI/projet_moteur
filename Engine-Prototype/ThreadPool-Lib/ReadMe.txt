========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet ThreadPool-Lib
========================================================================

AppWizard a créé ce projet de bibliothèque ThreadPool-Lib à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


ThreadPool-Lib.vcxproj
...
ThreadPool-Lib.vcxproj.filters
