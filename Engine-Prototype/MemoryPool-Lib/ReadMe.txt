========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet MemoryPool-Lib
========================================================================

AppWizard a créé ce projet de bibliothèque MemoryPool-Lib à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


MemoryPool-Lib.vcxproj
...
MemoryPool-Lib.vcxproj.filters
